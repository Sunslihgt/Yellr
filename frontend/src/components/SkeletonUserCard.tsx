...
//       <div className="flex-1 min-w-0">
//         <div className="h-4 rainbow-skeleton rounded w-1/2 mb-2" />
//         <div className="h-3 rainbow-skeleton rounded w-1/3" />
//       </div>
//       <div className="w-16 h-6 rainbow-skeleton rounded-full" />
//     </div>
//   </div>
// );
